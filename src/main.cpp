...
{
	if (nHeight == 1) return  1477777 * COIN;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Vires";
        unsigned int nTimeGenesis = 1509439769;
        unsigned int nNonceGenesis = 367093;

        if (fTestNet)
        {
            pszTimestamp ="Vires";
            nTimeGenesis = 1509439768;
            nNonceGenesis = 188833;
        }
...
//         printf("End Genesis Block\n");
        ...
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0x96cafd12934a1d92c8bec70cb2da08484540222b7eb2fdd06ea0b49c7be46927"));
        else
            assert(block.hashMerkleRoot == uint256("0xa402b2363130230d1800707104e2d18cf8f2988c1318a25ca724eeedefbb4f56"));
...
unsigned char pchMessageStart[4] = { 0x03, 0xd4, 0x02, 0xa5 };
